...
{
    //加载着色器
    self.program = [MHProgramLink loadProgramVertFileName:@"test8v.vs" fragFileName:@"test8f.fs"];
...
-(void)timerRun
{
    ...
    ksRotate(&modelMat, self.mDegreeX, 1.0, 0.0, 0.0);
    ksRotate(&modelMat, self.mDegreeX, 0.0, 1.0, 0.0);
    ksRotate(&modelMat, self.mDegreeX, 0.0, 0.0, 1.0);
