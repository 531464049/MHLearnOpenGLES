...
-(void)render
{
    ...
    ksMatrixTranslate(&_modelViewMatrix, 0.0, 0.0, -10.0);
    
    //旋转
    ksMatrix4 _rotationMatrix;
    ksMatrixLoadIdentity(&_rotationMatrix);
    ksMatrixRotate(&_rotationMatrix, degree, 1.0, 0.0, 0.0); //绕X轴
    ksMatrixRotate(&_rotationMatrix, yDegree, 0.0, 1.0, 0.0); //绕Y轴
