...
//    glEnableVertexAttribArray(mapColor);
    ...
    ksTranslate(&_modelViewMatrix, 0.0, 0.0, -2.0f);
    ksRotate(&_modelViewMatrix, self.mDegreeX, 1.0, 0.0, 0.0);
    ksRotate(&_modelViewMatrix, self.mDegreeY, 0.0, 1.0, 0.0);
    ksRotate(&_modelViewMatrix, self.mDegreeZ, 0.0, 0.0, 1.0);
