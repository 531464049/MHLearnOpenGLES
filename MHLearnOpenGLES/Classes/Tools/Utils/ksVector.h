...
extern "C" {
#endif
ksVec3 ksVectorLoad(float x,float y,float z);
void ksVectorSet(ksVec3 * out, float x, float y, float z);
...
void ksVectorMultiply(ksVec3 * out, const ksVec3 * a, const ksVec3 * b);
